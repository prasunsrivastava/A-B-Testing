...
* Standard Deviations
    1. Gross Conversion: 
   ```{r gross calc, echo=FALSE}
   ctr <- 3200/40000
   number_of_clicks <- 5000 * ctr
   SE <- sqrt((0.20625*(1-0.20625))/number_of_clicks)
   ```
        + N = `r number_of_clicks`  
        + SE~GrossConversion~ = `r SE`  
    2. Net Conversion:
    ```{r net calc, echo=FALSE}
    SE_Net_conversion <- sqrt((0.1093125*(1-0.1093125))/number_of_clicks)
    ```
        + SE~NetConversion~ = `r SE_Net_conversion`
